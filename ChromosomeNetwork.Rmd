...
V(g2)$color <- c("gray80", "gray60", "gray60","gray60","gray50","gray80","gray20","gray60","gray60","gray60", "gray80", "gray60", "gray70", "gray40","gray40","gray20", "gray70","gray60","gray40","gray50","gray70")   
V(g2)$label.cex = 0.5
plot(g2, layout = layout.auto, edge.width=(E(g)$GR)/10)
legend(locator(1), c("62","64","65", "66", "67", "68"),pch=c(16,16,16,16,16,16),col=c("gray20", "gray40", "gray50", "gray60", "gray70", "gray80"),cex=0.7)
